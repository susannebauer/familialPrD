...
dir <- "~/Documents/DataAnalysis_Ribotag/Prion_project/"
date <- Sys.Date()
...
pca <- ggplot(pcaData, aes(x = PC1, y = PC2, color = Group))+
  ...
  labs(title = paste0(disease," - ", vsd$Cell_type[1]," - ",  vsd$Region[1]),
       ...
       color = "Genotype")
ggsave(file = paste0(dir, "figures/DESeq2/",disease,"/",disease_samples,"_PCA.png"), plot = pca, dpi = 300)
...
deg_heat <- pheatmap(z_scores,
         ...
         legend = T)
deg_heat
ggsave(file = paste0(dir, "figures/DESeq2/",disease,"/",disease_samples,"_heat_deg.png"), plot = deg_heat)
...
Volcano 
ggsave(file = paste0(dir, "figures/DESeq2/",disease,"/",disease_samples,"_Volcano.png"), plot = Volcano, dpi = 300)
```
...
write.csv(ora_deg, file = paste0(dir, "result_files/DESeq/", disease, "/Enrichr_",disease_samples,".csv" ))
...
top10_gs <- ora_deg %>%
  ...
  slice_head(n = 10)
write.csv(ora_deg, file = paste0(dir, "result_files/DESeq/", disease, "/Enrichr_top5_",disease_samples,".csv" ))
...
ggsave(file = paste0(dir, "figures/DESeq2/", disease, "/", disease_samples,"fdr001_gs_tile.png"), dpi = 300, units = "cm", height = 15, width = 25)
...
ggsave(file = paste0(dir, "figures/DESeq2/", disease, "/", disease_samples,"_ORAtile_up.png"), dpi = 300, units = "cm")
...
ggsave(file = paste0(dir, "figures/DESeq2/", disease, "/", disease_samples,"_ORAtile.png"), dpi = 300, units = "cm", height = 40, width = 25)
...
write.csv(as.data.frame(resOrdered), file = paste0(dir,"intermediate_files/",disease,"/DESeq2_", disease_samples,".csv"))
...
writeLines(capture.output(run_info), paste0(dir,"documentation/Run_info_DESeq2_",disease_samples,".txt"))
